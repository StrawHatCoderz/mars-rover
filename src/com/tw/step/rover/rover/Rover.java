...
public class Rover {
  ...
  public Rover(String id, Coordinate coordinate, Direction heading) {
    ...
    this.roverStatus = RoverStatus.ACTIVE;
  }
  ...
  void markDead() {
    this.roverStatus = RoverStatus.LOST;
  }

  @Override
  public String toString() {
    if (roverStatus == RoverStatus.ACTIVE) {
      return coordinate.toString() + " " + heading.toString();
    }

    return coordinate.toString() + " " + heading.toString() + " " + RoverStatus.LOST;
  }
}
